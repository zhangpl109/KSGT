...
def main():
    ...
    # Add argument
    parser.add_argument('--n_iter', type=int, default=, help='number of iterations')
    parser.add_argument('--fold', type=int, default=, help='[0, 1, 2]')
    parser.add_argument('--epochs', type=int, default=, help='number of epochs')
    parser.add_argument('--weight_decay', type=float, default=, help='weight decay')
    ...
    for epoch in range(epochs):
        ...
        for data in train_loader:
            ...
            running_loss.update(loss.item(), label.size(0))
            print("acc:{:.3f},loss:{:.3f}".format(acc,loss.item()))
